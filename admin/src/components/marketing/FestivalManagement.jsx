  ...
  if (isLoading) {
    return (
      <div className="card p-12 text-center">
        <div className="text-ink/60">Loading festivals...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-ink">Festival Management</h2>
          <p className="text-sm text-ink/60">Configure seasonal festival configurations</p>
        </div>
