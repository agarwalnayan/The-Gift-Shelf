...
const CartDrawer = () => {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed right-0 top-0 z-50 flex h-full w-full max-w-md transform flex-col overflow-x-hidden bg-cream shadow-2xl transition-transform duration-300 ease-out ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
                role="dialog"
                aria-modal="true"
