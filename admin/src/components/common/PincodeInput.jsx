    ...
    <div className={`relative ${className}`}>
      <div className="relative">
        <input
          ...
          disabled={disabled}
          maxLength={6}
          className={`w-full rounded-xl border px-4 py-2.5 outline-none pr-20 text-sm focus:border-primary-500 focus:ring-1 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed ${
        ...
        <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
          {loading && (
            <div className="text-ink/40 text-xs">Looking up...</div>
          )}
